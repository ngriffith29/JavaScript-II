...
let largeShirts = runners.filter(e => e.shirt_size.toUpperCase() === "L");
...
let prices = [];
runners.forEach(e => prices.push(e.donation));
let ticketPriceTotal = prices.reduce((total, amount) => total + amount);
...
runners.forEach(e => email.push(e.email));
console.log(email);

// Problem 2
let companyName = runners.map(e => e.company_name);
console.log(companyName);

// Problem 3

let MediumShirt = runners.filter(e => e.shirt_size.toUpperCase() === "M");
